...
resource "aws_iam_role" "iam_for_lambda" {
  name               = "iam_for_lambda-${var.account_id}-${var.env}-${var.tag}"
...
resource "aws_iam_policy" "lambda_iam_policy" {
  name   = "lambda-iam-policy-${var.account_id}-${var.env}-${var.tag}"
  path   = "/"
...
resource "aws_iam_role" "task_role_for_ecs_task" {
  name               = "task_role_for_ecs_task-${var.account_id}-${var.env}-${var.tag}"
